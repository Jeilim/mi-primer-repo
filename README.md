...
# EDA 2 - JACQUELINE PAOLA LEYVA HERNANDEZ

## Funciones

- *double()*: Recibe un arreglo como parámetro y retorna una nueva lista que multiplica _*2_ cada elemento de la lista original.
